...
ALTER TABLE vault_files ADD COLUMN IF NOT EXISTS file_hash VARCHAR(64);
ALTER TABLE vault_files ADD COLUMN IF NOT EXISTS file_size BIGINT DEFAULT 0;
ALTER TABLE vault_files ADD COLUMN IF NOT EXISTS version INTEGER DEFAULT 1;
ALTER TABLE vault_files ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE;
